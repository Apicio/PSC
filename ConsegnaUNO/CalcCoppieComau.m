...
%Gravita'      : Coppie di Gravit�� g(qDH)
%JTh          : forze e momenti agenti sui giunti derivanti dalle
...
ddqDH(:, 1) = u(13:18);
cd 'utilis'
[G, Cordq, ~, Fv, B] = generateModel(qDH', dqDH');
cd ..
Inerzia = B*ddqDH;
AttritoViscoso = Fv*dqDH;
out = [Inerzia; Cordq; AttritoViscoso; G];
