...
% -  i-1,i
% - gx,gy,gz    : accelerazione di gravit� (il segno � positivo dal basso verso l'alto)
...
% ***********************************************************************************************************************
% Conversione delle coppie e delle velocit� in funzione degli organi di tramissione
% ***********************************************************************************************************************
...
%     r56z =  d(6);
% 
% % accelerazione di gravit� (il segno di g � positivo dal basso verso l'alto nel sistema inerziale)
...
%     molla_datinominali.ON   = 1                         ; % flag per indicare se la molla � presente (1) o meno (0)      {0,1} 
%   else                                         
%     molla_datinominali.ON   = 0                         ; % flag per indicare se la molla � presente (1) o meno (0)      {0,1} 
